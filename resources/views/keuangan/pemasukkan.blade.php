                                            ...
                                            <div class="modal-content">
                                                ...
                                                <form method="post">
                                                    <div class="modal-body">
                                                        ...
                                                        <input type="text" name="jumlah_pemasukan" value=""
                                                            placeholder="Jumlah_Pemasukan" class="form-control"
                                                            required>
                                                        <br>
                                                        ...
                                                        <button type="submit" class="btn btn-primary"
                                                            name="updatepemasukan">Simpan</button>
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
                                    ...
                                    <div class="modal fade" id="deleteModal" tabindex="-1"
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <!-- Modal Header -->
                                                <div class="modal-header">
                                                    <h4 class="modal-title" id="exampleModalLabel">Hapus Pemasukkan
                                                    </h4>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                        aria-label="Close"></button>
                                                </div>
...
<div class="modal fade" id="myModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="post">
                <div class="modal-body">
                    <input type="text" name="jumlah_pemasukan" placeholder="Jumlah Pemasukkan"
