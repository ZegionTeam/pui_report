...
<div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <!-- Modal Body -->
            <form method="POST" action="{{ route('menu.update', 'id') }}" id="EditForm">
                @csrf
                @method('PUT')
                <div class="modal-body">
                    <input type="hidden" name="id" value="">
                    <input type="text" name="name" value="" placeholder="Nama Menu"
                        class="form-control" required>
                    <br>
                    <input type="number" name="price" value="" placeholder="Harga" class="form-control"
                        required>
                    <br>
                    <input type="text" name="description" value="" placeholder="Deskripsi"
                        class="form-control" required>
                    <br>
                    <select name="category" class="form-control">
                        <option value="Chicken">Chicken</option>
...
<script>
    ...
    $('#editModal').on('show.bs.modal', function(event) {
        ...
        var name = button.data('name'); // Mengambil data-name
        var price = button.data('price'); // Mengambil data-price
        var description = button.data('description'); // Mengambil data-description
        var category = button.data('category'); // Mengambil data-category
        var form = document.getElementById('EditForm');
        form && form.setAttribute('action', '/menu/' + id);
        var modal = $(this);
